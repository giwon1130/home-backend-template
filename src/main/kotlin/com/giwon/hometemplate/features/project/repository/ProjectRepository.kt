...
class ProjectRepository(
    ...
    private val projects = listOf(
        ...
        Project(
            ...
            headline = "한국·미국 시장 시그널과 실험 대체지표를 웹·모바일로 함께 읽는 개인용 시장 인텔리전스 허브",
            summary = "한국/미국 시장을 분리해 지수 차트, 수급, 공포지표, 뉴스 군집화, 포트폴리오, AI 추천, 모의투자와 함께 Pentagon Pizza Index 기반 실험 지표까지 웹과 모바일 컴패니언 앱으로 제공하는 시장 인텔리전스 서비스",
